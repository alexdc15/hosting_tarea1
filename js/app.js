...
function initScene() {
    ...
    orbits.forEach(orbit => {
        ...
        meteors.forEach(pos => {
            ...
            meteor.setAttribute('gltf-model', 'low_poly_ju-stuka/scene.gltf')
            meteor.setAttribute('class', 'plane')
...
AFRAME.registerComponent('shootable', {
    init: function () {
        this.el.addEventListener('click', () => {
            ...
            document.querySelector('[text]').setAttribute('value', `${++score} STUKAS DERRIBADOS`)
        })
    }
})